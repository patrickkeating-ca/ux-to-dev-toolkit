...
**Week 3:** Git on your computer (local)
**Week 4:** Git in the cloud (remote = GitHub)
...
**Repository name:** `ux-practice-week4`
...
**It looks like:**
```
https://github.com/yourusername/ux-practice-week4.git
```
...
**Navigate to your Week 3 practice folder:**
```bash
...
You should see your commits from Week 3.
...
4. Everything from Week 3 is now on GitHub!
...
**What you have:**
- Original folder: `~/Desktop/week3-practice`
- Cloned folder: `~/Desktop/github-clones/ux-practice-week4`
...
1. Go to your repository on GitHub
2. Open the same file: `03-week3-practice-repository.md`
...
```
Auto-merging 03-week3-practice-repository.md
CONFLICT (content): Merge conflict in 03-week3-practice-repository.md
...
By Week 5, pushing to GitHub will feel as natural as saving a file.
...
Next week: You'll learn how teams actually use this for real projects.

Excellent work. See you in Week 5.
