# Lesson 4 Express: GitHub & Remote Repos
...
**Navigate to your git-test folder from Lesson 3:**
```bash
cd ~/Desktop/git-test
```
...
The full Lesson 4 lesson includes:
...
## When to Return to Full Lesson 4
...
Lesson 5 Express will teach you branches and pull requests (how teams collaborate).
