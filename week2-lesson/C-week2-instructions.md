...
**Or from VS Code:**
1. File → Open Folder
2. Navigate to Desktop → week2-practice
3. Click "Open"
...
**This week's theme:** Tools make the work easier.

Next week, these tools become automatic and you'll focus on Git itself.
...
**Preparation:** 
- Make sure this week's shortcuts feel natural
- Practice terminal navigation from Week 1
...
By Week 4, you'll be flying through files without thinking about it.
