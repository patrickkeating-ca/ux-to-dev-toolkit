# Prerequisites Check - Lesson 3
## Git Basics (Local)

### Before Starting This Lesson

Lesson 3 introduces Git - the version control system that tracks changes to your files. This lesson focuses on local Git operations (on your computer only, no GitHub yet).

---

## Lesson 1 & 2 Completion Check

You should have already:

- [ ] Completed Lesson 1 (Terminal basics, markdown)
- [ ] Completed Lesson 2 (VS Code setup, shortcuts)
- [ ] Comfortable using Terminal commands
- [ ] Can open folders in VS Code with `code .`
- [ ] Installed VS Code extensions
- [ ] Used keyboard shortcuts successfully

**If you haven't done Weeks 1-2:** Go back and complete them first. Lesson 3 builds directly on those skills.
...
**If those feel unfamiliar:** Review Lesson 1 before continuing.

**If those feel natural:** You're ready for Lesson 3.
...
**If no to any:** Review Lesson 2 shortcuts before continuing.
...
Use your real name and work email (same email you'll use for GitHub in Lesson 4).
...
### 5. Create Lesson 3 Practice Folder

```bash
cd ~/Desktop
mkdir lesson03-practice
cd lesson03-practice
```
...
You should see: `/Users/YourName/Desktop/lesson03-practice`

---

## What You'll Learn This Week

This lesson focuses on **local Git** - everything happens on your computer. No GitHub, no internet needed.
...
- Push to GitHub (that's Lesson 4)
- Work with branches (Lesson 4)
- Collaborate with others (Lesson 5)
...
For this lesson, download these files to your `lesson03-practice` folder:

1. `D-lesson03-practice-repository.md` - File to track with Git
2. `E-lesson03-practice-gitignore.txt` - Practice creating .gitignore
3. `F-lesson03-solution-history.md` - What your git log should look like

**How to get them:**
- Download from lesson folder
- Move them to `~/Desktop/lesson03-practice`
...
- This lesson: Just Git, no GitHub
...
- [ ] Created `lesson03-practice` folder
- [ ] Downloaded practice files to the folder
- [ ] Understand Git tracks changes (not creates multiple files)

**All checked?**

Proceed to `C-lesson03-instructions.md`

---

## If You're Not Ready

**Lesson 1 or 2 still feels shaky:**
...
**If Weeks 1-2 are solid:** 15-20 minutes for Lesson 3 lesson

**If Weeks 1-2 are shaky:** Review those first, then 20-30 minutes for Lesson 3
...
**Resources:**
- Lesson 1 materials (Terminal review)
- Lesson 2 materials (VS Code review)
- Team channel: [your channel]
- Office hours: [day/time]

**Remember:** Git feels strange at first because it's a completely new concept. By Lesson 4, it'll click.
...
**By next lesson, you'll wonder how you ever worked without it.**

---

## Ready?

Once you've completed this checklist and verified Git works, proceed to `C-lesson03-instructions.md` to begin learning local Git operations.
