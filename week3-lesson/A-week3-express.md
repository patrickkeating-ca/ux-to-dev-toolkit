# Week 3 Express: Git Basics (Local)
...
The full Week 3 lesson includes:
...
**For now, move to Week 4 to connect Git to GitHub.**
...
- Week 4 covers undoing mistakes
...
Week 4 Express will connect this local Git to GitHub (the cloud).

**Time saved: ~45-60 minutes**

**Note:** Week 3 is conceptually the hardest. If this felt confusing, consider taking the full lesson. Git is worth understanding properly.
