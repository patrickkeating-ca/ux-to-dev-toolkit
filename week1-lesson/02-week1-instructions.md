...
**You should see:** `/Users/YourName/Desktop/week1-practice`
...
**While still in `week1-practice` folder:**
...
2. Move it to your `week1-practice` folder (on your desktop)
...
- Try: File → Open Folder → select `week1-practice`
...
After Week 2, these commands will feel natural. After Week 4, you'll do them without thinking.
...
**Preparation:** None needed - just complete this week's exercise.
