# Prerequisites Check - Week 1
## Verify Your Setup Before Starting

### Quick Setup Verification

Before starting Week 1's lesson, verify you have the required tools installed.
...
Before starting Week 1 lesson, verify:
...
Once you've completed this checklist, proceed to `week1-instructions.md` to start the hands-on lesson.
